# Generated by Django 2.2.7 on 2020-03-11 13:15
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('streamprocessors', '0057_merge_20200309_0623'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(blank=True, max_length=200, verbose_name='Select Field Name'),
        ),
        migrations.AlterField(
            model_name='streamprocessorstep',
            name='result_placement',
            field=models.CharField(blank=True, choices=[('aggregate', 'Aggregate Results'), ('join', 'Join Results To Inbound'), ('joininbound', 'Join Inbound To Results'), ('publish', 'Publish Onto Stream'), ('replace', 'Replace Inbound Event With Results')], max_length=20, null=True, verbose_name='Result Placement'),
        ),
        migrations.AlterField(
            model_name='streamprocessorstep',
            name='steptype',
